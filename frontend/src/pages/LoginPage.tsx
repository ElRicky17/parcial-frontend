...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.data.role === "ANDREI") navigate("/andrei");
      else if (res.data.role === "DAEMON") navigate("/daemons");
      else if (res.data.role === "NETWORK_ADMIN") navigate("/network");
    } catch (err) {
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-gray-950 via-red-950 to-black flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        {/* Additional dark overlay to ensure no white spaces */}
      ...
      <div className="absolute inset-0 pointer-events-none z-10">
        {[...Array(15)].map((_, i) => (
          ...
          >
            {["docker", "kubectl", "DevOps", "chaos", "network", "admin", "daemon"][Math.floor(Math.random() * 7)]}
          </div>
        ))}
      </div>
      ...
      <div className="relative w-full max-w-lg z-20">
        ...
        <div className="relative bg-gray-800/95 backdrop-blur-xl border border-gray-700/30 rounded-3xl p-10 shadow-2xl">
          ...
          <div className="text-center mb-10">
            {/* Logo/Icon - Warlock Symbol */}
            <div className="mx-auto w-24 h-24 bg-gradient-to-br from-red-600 via-orange-500 to-yellow-500 rounded-2xl flex items-center justify-center mb-8 shadow-xl transform rotate-45 relative overflow-hidden">
            ...
            {/* Title */}
            <h1 className="text-4xl font-bold bg-gradient-to-r from-red-400 via-orange-400 to-yellow-400 bg-clip-text text-transparent mb-3 tracking-wider">
              ANDREI'S EMPIRE
            </h1>
            <p className="text-gray-200 text-base font-light tracking-wide">
              Where DevOps nightmares become reality
            </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="space-y-3">
              ...
              <div className="relative group">
                ...
                <input
                  type="email"
                  placeholder="admin@empire.chaos"
          ...
          <div className="mt-10 text-center space-y-2">
            ...
            <p className="text-xs text-gray-200 italic font-light tracking-wider">
              "Automation is the enemy, chaos is the way"
            </p>
            <p className="text-xs text-gray-200 font-mono">
              - Andrei Mes Manur, Failed Warlock
            </p>
          </div>
        </div>
